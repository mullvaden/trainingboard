...
namespace Chello.Core
{
	public class MemberService : TrelloApiBase
	{
		...
		public string GravatarHash(string username)
		{
            return GetRequest("/members/{0}/gravatarHash", username);
		}

		public string AvatarHash(string username)
		{
            return GetRequest("/members/{0}/avatarHash", username);
		}
