...
namespace Chello.Tests
{
	class BasicTestData
	{
		public static TestData Create()
		{
            ...
            testData.Add(new Comment { Id = "TESTCOMMENT1", IdCard = "TESTCARD1", Text = "Test Comment" });
			...
			// TODO: Can we make this stuff automatically link up with the IdBoard (etc.) properties?
			testData.AddRelationship<Member, Organization>("TESTMEMB1", "TESTORG1");
			testData.AddRelationship<Card, Board>("TESTCARD1", "TESTBOARD1");
            testData.AddRelationship<Comment, Board>("TESTCOMMENT1", "TESTBOARD1");
