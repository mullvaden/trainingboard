...
namespace Chello.Tests
{
	public class TestData
	{
        ...
        public static string UserName = "danielbrunteson";
        public static string BoardName = "traning";
        public static string TestBoardId = "525e6a9a59cd705c56001cc5";
        public static string LiveBoardId = "525bcdf08e8ccd036e00762d";
		public static string CardName = "TESTCARD1";
        public static string CommentName = "TESTCOMMENT1";
        public static DateTime CommentDate = new DateTime(2013, 1, 4, 22, 50, 10, 123);
        public static string OrganizationName = "numlock";
